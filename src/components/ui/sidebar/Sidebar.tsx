...
export const Sidebar = ({ open, setOpen, navLinks }: Props) => {
  ...
  return <>
    ...
    {/* SideMenu */}
    <nav className={`fixed p-5 right-0 top-0 w-[400px] h-screen bg-light dark:bg-soft-black z-20 shadow-2xl transform transition-all duration-300 ${!open ? "translate-x-full" : ""}`}>
