      ...
      >
        ...
        <div className="px-6 py-5 border-t border-line/5">
          <div className="flex items-center justify-between mb-4">
            <span className="font-inputmono text-[11px] text-faint tracking-widest uppercase">{tc("theme")}</span>
            <ThemeSelector />
          </div>
          <div className="flex items-center justify-between mb-5">
            <span className="font-inputmono text-[11px] text-faint tracking-widest uppercase">{tc("lang")}</span>
            <LocaleSwitcher />
          </div>
