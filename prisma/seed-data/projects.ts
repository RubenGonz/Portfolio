...
export const projects: Project[] = [
  {
    ...
    highlights: [
      ...
      "Dark-only theme, two local fonts via next/font (zero layout shift), Tailwind CSS v4, TS strict",
    ],
